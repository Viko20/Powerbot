...
public class WalkToChickens extends Task {
    ...
    final static Area CHICKEN_AREA = new Area(new Tile(3226, 3300, 0), new Tile(3236, 3295, 0));
    final Walker walk = new Walker(ctx);


    public WalkToChickens(ClientContext arg0) {
        super(arg0);
    }
    ...
    public void execute() {
        ...
        System.out.println("Executing WalkToChickens");
